...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#分层)分层
...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#图层绘制)图层绘制
...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#栅格化（raster）操作)栅格化（raster）操作
...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#合成和显示)合成和显示
...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#渲染流水线大总结)渲染流水线大总结
...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#相关概念)相关概念

有了上面介绍渲染流水线的基础，我们再来看看三个和渲染流水线相关的概念——“重排”“重绘”和“合成”。理解了这三个概念对于你后续Web的性能优化会有很大帮助。

### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#_1-更新了元素的几何属性（重排）)1. 更新了元素的几何属性（重排）
...
### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#_2-更新元素的绘制属性（重绘）)2. 更新元素的绘制属性（重绘）
...
### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#_3-直接合成阶段)3. 直接合成阶段
...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#总结)总结

通过本文的分析，你应该可以看到，Chrome的渲染流水线还是相当复杂晦涩，且难以理解，不过Chrome团队在不断添加新功能的同时，也在不断地重构一些子阶段，目的就是让整体渲染架构变得更加简单和高效，正所谓大道至简。

## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson06.html#思考时间)思考时间
...
### 🤔 Question:transform动画为什么不导致重排和重绘？
