...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson02.html#一个数据包的“旅程”)一个数据包的“旅程”
...
### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson02.html#_1-ip：把数据包送达目的主机)1. IP：把数据包送达目的主机
...
### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson02.html#_2-udp：把数据包送达应用程序)2. UDP：把数据包送达应用程序
...
### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson02.html#_3-tcp：把数据完整地送达应用程序)3. TCP：把数据完整地送达应用程序
...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson02.html#总结)总结
